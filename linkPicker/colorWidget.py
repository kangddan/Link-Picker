...
class _IndexColorPicker(QtWidgets.QDialog):
    ...
    def _createWidgets(self):
        colors = [self.indexToQtColor(i) for i in range(0, 32)]
...
class ColorWidget(QtWidgets.QLabel):
    ...
    def _createActions(self):
        self.RGBAction      = QtWidgets.QAction('RGB   Color Picker')
        self.indexAction    = QtWidgets.QAction('Index Color Picker')
